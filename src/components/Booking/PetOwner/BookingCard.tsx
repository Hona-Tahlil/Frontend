...
import type { CardStatus, CommentStatus } from "@/types/bookingCardTypes";
			...
			<div className="relative w-full h-full">
				...
				<div className="flex gap-5">
					<div className="flex flex-col items-center">
						...
						{isMobile && <p className="text-2xl">تست</p>}
					</div>
					<div className="flex-1 flex flex-col gap-2">
						{!isMobile && <p className="text-2xl">تست</p>}
						{!isMobile && <p className="text-xl">تست</p>}
						<div className="flex flex-col items-center sm:flex-row gap-3 sm:gap-[5%] md:gap-[10%]">
						...
						<p className="text-xl w-full text-left">تست</p>
						<div className="w-full flex justify-end gap-2">
							<Button
								className="shadow-none h-8 py-0 !opacity-0"
								disabled
							></Button>
							{cardStatus == "accepted" && (
							...
							{cardStatus != "rejected" && cardStatus != "canceled" && (
								<Button
									shadow={false}
									variant={"outline"}
