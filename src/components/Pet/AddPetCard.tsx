...
function CardStyle() {
  return (
    <div
      className="border-4 border-primary border-dotted w-full h-80 bg-primary-200 flex-col rounded-lg flex justify-center items-center text-primary hover:cursor-pointer"
    >
