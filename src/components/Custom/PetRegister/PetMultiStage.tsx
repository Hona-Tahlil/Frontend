...
export default function Stepper({
  ...
  const [prevButtonHover, setPrevButtonHover] = useState<boolean>(false);
  ...
  return (
    ...
    >
      <div
        className={`mx-auto h-full flex flex-col w-full max-w-md rounded-4xl ${stepCircleContainerClassName}`}
      >
        <div
