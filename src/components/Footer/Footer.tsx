      ...
      <div className="bg-teal-900 text-white py-8 rtl">
        <div className="flex justify-center">
          ...
          <div className="w-full flex justify-center items-start">
            <div className="flex flex-col justify-center w-fit">
              <p className="text-lg font-bold px-4 whitespace-nowrap">راه‌های ارتباطی</p>
              <ul className="space-y-1 mt-5">
                <li>
                  <Button className="text-white" variant="link" shadow={false}>
                    ایمیل
          ...
          <div className="w-full flex justify-center items-start">
            <div className="flex flex-col justify-center w-fit">
              <p className="text-lg whitespace-nowrap font-bold">شبکه‌های اجتماعی</p>
    ...
    <footer className="w-full bottom-0 ">
      <div className="bg-teal-900 text-white py-8 rtl">
        <div className="grid grid-cols-2 gap-y-10 gap-x-4 justify-items-center">
          ...
          <div className="flex flex-col items-start">
            <p className="text-lg font-bold whitespace-nowrap">شبکه‌های اجتماعی</p>
            <div className="mt-3 flex items-center gap-4">
              <a
                href="https://t.me/yourchannel"
                target="_blank"
